...
public interface ViewsSortable extends Recordable {
    ...
    class Data extends Modification<ViewsSortable> {

        public static final String FIELD_PREFIX = "views.";
        public static final String SORT_FIELD = FIELD_PREFIX + "getSortValue";
        public static final String SORT_FIELD_INDEX = ViewsSortable.class.getName() + "/" + SORT_FIELD;
